namespace MGroup.Solvers.DDM.PSM.Scaling
{
	...
	public class HomogeneousScaling_v2 : IBoundaryDofScaling
	{
		...
		public HomogeneousScaling_v2(IComputeEnvironment environment, Func<int, PsmSubdomainDofs_v2> getSubdomainDofs)
		{
