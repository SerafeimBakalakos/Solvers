namespace MGroup.Solvers.DDM.PSM.InterfaceProblem
{
	...
	/// </summary>
	public class PsmInterfaceProblemMatrixImplicit_v2 : IPsmInterfaceProblemMatrix
	{
		private readonly IComputeEnvironment environment;
		private readonly Func<int, PsmSubdomainDofs_v2> getSubdomainDofs;
		private readonly Func<int, IPsmSubdomainMatrixManager_v2> getSubdomainMatrices;

		public PsmInterfaceProblemMatrixImplicit_v2(IComputeEnvironment environment, Func<int, PsmSubdomainDofs_v2> getSubdomainDofs, 
			Func<int, IPsmSubdomainMatrixManager_v2> getSubdomainMatrices)
		{
