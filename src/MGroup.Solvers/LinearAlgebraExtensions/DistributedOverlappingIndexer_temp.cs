...
//		private Dictionary<int, LocalIndexer_temp> localIndexers;
//		private GlobalIndexer_temp globalIndexer;
...
//		public GlobalIndexer_temp GlobalIndexer
//		{
//			get
//			{
...
//		public void Initialize(Func<int, LocalIndexerDto_temp> getLocalIndexingData)
//		{
//			localIndexers = Environment.CalcNodeData(nodeID =>
//			{
//				LocalIndexerDto_temp dto = getLocalIndexingData(nodeID);
//				return new LocalIndexer_temp(Environment.GetComputeNode(nodeID), dto.CommonEntriesOfNodeWithNeighbors, dto.NumIndices);
//			});
//			CountUniqueEntries();
//		}
...
//		public DistributedOverlappingIndexer ReuseAsBasisForNewIndexer(Func<int, LocalIndexerDto_temp> getLocalIndexingData)
//		{
...
//		internal Dictionary<int, LocalIndexer_temp> AllGatherLocalIndexers()
//		{
//			Dictionary<int, LocalIndexerDto_temp> transferedDtos = Environment.AllGather(
//				nodeID => LocalIndexerDto_temp.CreateForSerialization(this.localIndexers[nodeID])
//			);

//			var result = new Dictionary<int, LocalIndexer_temp>();
...
//		private GlobalIndexer_temp CreateGlobalIndexerIfMissing()
//		{
...
//					{
//						globalIndexer = new GlobalIndexer_temp(localIndexers, NumGlobalIndices);
//					}
//				}
//			}
