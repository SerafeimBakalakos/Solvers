...
//			get
//			{
//				CheckGlobalIndex2D(Indexer, rowIdx, colIdx);
...
//		private static void CheckGlobalIndex2D(DistributedOverlappingIndexer indexer, int rowIdx, int colIdx)
//		{
//			if (rowIdx < 0 || rowIdx >= indexer.NumGlobalIndices)
//			{
//				throw new IndexOutOfRangeException(
//					$"The row index must be in the range [0, {indexer.NumGlobalIndices}), but was {rowIdx}");
//			}

//			if (colIdx < 0 || colIdx >= indexer.NumGlobalIndices)
//			{
//				throw new IndexOutOfRangeException(
//					$"The column index must be in the range [0, {indexer.NumGlobalIndices}), but was {colIdx}");
//			}
//		}
//	}
//}
