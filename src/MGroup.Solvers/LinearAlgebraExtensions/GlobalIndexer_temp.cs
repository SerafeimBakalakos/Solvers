...
//	public class GlobalIndexer_temp
//	{
//		/// <summary>
...
//		public GlobalIndexer_temp(Dictionary<int, LocalIndexer_temp> localIndexers, int numGlobalIndices)
//		{
...
//			{
//				LocalIndexer_temp localIndexer = localIndexers[nodeID];
...
//		public void WriteLocalToGlobalMaps()
//		{
//			foreach (int elemID in localToGlobal.Keys)
//			{
//				Debug.Write($"Element {elemID}: local-to-global dofs =");
//				foreach (int index in localToGlobal[elemID])
//				{
//					Debug.Write(" ");
//					Debug.Write(index);
//				}
...
//			int targetLocalIdx, Dictionary<int, LocalIndexer_temp> localIndexers)
//		{
//			var result = new List<(int, int)>();
//			LocalIndexer_temp targetLocalIndexer = localIndexers[targetNodeID];
