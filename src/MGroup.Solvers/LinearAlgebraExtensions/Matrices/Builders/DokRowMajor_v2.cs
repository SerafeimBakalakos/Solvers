...
namespace MGroup.Solvers.LinearAlgebraExtensions.Matrices.Builders
{
	...
	/// </summary>
	public class DokRowMajor_v2 : ISparseMatrix, IGeneralMatrixBuilder
	{
		/// <summary>
		...
		private DokRowMajor_v2(int numRows, int numCols, Dictionary<int, double>[] rows)
		{
			this.rows = rows;
		...
		/// <summary>
		/// Initializes a new instance of <see cref="DokRowMajor_v2"/> with the specified matrix dimensions and all entries being
		/// equal to 0.
		/// </summary>
		...
		public static DokRowMajor_v2 CreateEmpty(int numRows, int numCols)
		{
			...
			return new DokRowMajor_v2(numRows, numCols, rows);
		}

		/// <summary>
		/// Initializes a new instance of <see cref="DokRowMajor_v2"/> with the specified matrix dimensions and entries being 
		/// the same as the identity matrix.
		/// </summary>
		/// <param name="order">The number of rows/columns of the square matrix to build.</param>
		public static DokRowMajor_v2 CreateIdentity(int order)
		{
			...
			return new DokRowMajor_v2(order, order, rows);
		}

		/// <summary>
		/// Initializes a new instance of <see cref="DokRowMajor_v2"/> with the specified matrix dimensions and the non-zero 
		...
		///     <see cref="DokRowMajor_v2"/>.</param>
		public static DokRowMajor_v2 CreateFromSparseMatrix(ISparseMatrix matrix)
		...
		public static DokRowMajor_v2 CreateFromSparsePattern(int numRows, int numColumns,
			IEnumerable<(int row, int col, double value)> nonZeroEntries)
		{
			DokRowMajor_v2 dok = CreateEmpty(numRows, numColumns);
		...
		/// called after fully defining the matrix in <see cref="DokRowMajor_v2"/> format.
		/// </summary>
		...
		/// <summary>
		/// Frees all memory held by this <see cref="DokRowMajor_v2"/> instance. Afterwards this object cannot be reused. Therefore 
		...
		/// If there are no zero entries, -1 is returned as the index. The <see cref="DokRowMajor_v2"/> matrix must be square.
		/// </summary>
		...
		public DokRowMajor_v2 GetSubmatrix(int[] rowsToKeep, int[] colsToKeep)
		{
