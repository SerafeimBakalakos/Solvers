//TODO: Should sparsity pattern classes be together with MatrixBuilders, in a Reordering namespace in LinearAlgebra or in a Reordering namespace in Solvers?
...
namespace MGroup.Solvers.LinearAlgebraExtensions.Reordering
{
	using System;
	...
	public class SparsityPatternSymmetric : ISparsityPatternSymmetric
	{
		...
		public (int[] rowIndices, int[] colOffsets) BuildSymmetricCSCArrays(bool sortRowsOfEachCol)
		{
